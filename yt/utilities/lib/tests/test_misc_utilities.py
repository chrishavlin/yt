...
def test_cartesian_bboxes_for_spherical():
    ...
    _cartesian_bboxes_for_spherical(r, theta, phi,
                                    dr, dtheta, dphi,
                                    x, y, z,
                                    dx, dy, dz
                                    )
    ...
    phi_edges = np.linspace(0., 2 * np.pi, 10, dtype='float64')


    r = (r_edges[0:-1] + r_edges[1:])/2.
    theta = (theta_edges[0:-1] + theta_edges[1:])/2.
    phi = (phi_edges[0:-1] + phi_edges[1:])/2.
    ...
    _cartesian_bboxes_for_spherical(r_th_ph[0],
                                    r_th_ph[1],
                                    r_th_ph[2],
                                    d_r_th_ph[0],
                                    d_r_th_ph[1],
