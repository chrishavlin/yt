...
class BaseIOHandler:
    ...
    ) -> Mapping[FieldKey, NDArray[np.floating]]:
    ...
    def _read_particle_selection(
    ...
    ) -> dict[FieldKey, NDArray[np.floating]]:
        data: dict[FieldKey, list[NDArray[np.floating]]] = {}
        ...
        rv: dict[FieldKey, NDArray[np.floating]] = {}  # the return dictionary
