...
class ParticleIndex(Index):
    ...
    def _read_particle_fields(self, fields, dobj, chunk=None):
        ...
        fields_to_return = self.io._read_particle_data_file(
            data_file_subset, fields_to_read, selector=None
        )
    ...
    def apply_selector_mask(self, fields_to_return, selector):
        ...
        for field, vals in fields_to_return.items():
            if field[0] not in ptype_masks:
                ...
                # Note: the object that calls map_blocks will be supplied as the
                # first argument to the function being called
